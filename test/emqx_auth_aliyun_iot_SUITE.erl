...
t_gen_password_test() ->
  %% invalid param with no extra param
  {error, Error} = emqx_auth_aliyun_iot_util:gen_password("11111|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error),
  %% invalid param with invalid extra param
  {error, Error1} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error1),
  %% invalid param with invalid extra param
  {error, Error2} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3timestamp=2524608000000signmethod=hmacsha1|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error2),
  %% invalid param with empty client id
  {error, Error3} = emqx_auth_aliyun_iot_util:gen_password("", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error3),
  %% invalid param with empty username
  {error, Error4} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=hmacsha1|", "", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error4),
  %% invalid param with empty device secret
  {error, Error5} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=hmacsha1|", "test1&a1U4pQzrgim", ""),
  ?assertEqual(invalid_param, Error5),
  %% invalid param with invalid username
  {error, Error6} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=hmacsha1|", "test1", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(invalid_param, Error6),
  %% invalid param with unsupported sign method
  {error, Error7} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=sha256|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual(unsupported_sign_method, Error7),
  %% correct case with timestamp
  {ok, Result} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,timestamp=2524608000000,signmethod=hmacsha1|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual("88794a49fc0663f9eb3eb3c97194d2f76d10329b", Result),
  %% correct case without timestamp
  {ok, Result1} = emqx_auth_aliyun_iot_util:gen_password("11111|securemode=3,signmethod=hmacsha1|", "test1&a1U4pQzrgim", "fc73ae4f1f2fb21073f1eee685cf4435"),
  ?assertEqual("76e7345890a94bedcb3220d83012e288fa46a5ee", Result1).
